<x-layouts.default>
    <nav class="navbar bg-base-100 rounded-box shadow-base-300/20 shadow-sm sticky top-4 z-50 border-b-2">
        <div class="flex flex-1 items-center">
            <a class="link text-base-content link-neutral text-xl font-bold no-underline" href="{{ route('home') }}">
                <span class="icon-[tabler--hexagon-letter-f] text-base-content/80 size-7 shrink-0"
    ...
    <form
    method="post", action="{{ route('tweet.create') }}"
        ...
        <div class="textarea-floating">
            <textarea required class="textarea border-0 resize-none" placeholder="شارك أفكارك" id="content" name="content"></textarea>
        ...
        <div class="p-2 pt-0">
            ...
            <button type="submit" class="btn btn-primary btn-square">
                <span class="icon-[tabler--message-circle-share] size-6"></span>
            </button>
        </div>
    </form>
</x-layouts.default>